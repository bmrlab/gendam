...
export type Procedures = {
    queries: 
        ...
        { key: "assets.trash", input: FilePathQueryPayload, result: Trash[] } | 
    ...
    mutations: 
        ...
        { key: "assets.delete_trash_file_path", input: FilePathDeletePayload, result: null } | 
        ...
        { key: "assets.move_trash_file_path", input: FilePathMovePayload, result: null } | 
        { key: "assets.process_video_asset", input: number, result: null } | 
        { key: "assets.process_video_metadata", input: number, result: null } | 
        { key: "assets.put_back", input: FilePathDeletePayload, result: null } | 
...
export type Trash = { id: number; isDir: boolean; originParentId: number | null; materializedPath: string; name: string; description: string | null; assetObjectId: number | null; createdAt: string; updatedAt: string }
...
export type AssetObject = { id: number; hash: string; size: number; mimeType: string | null; createdAt: string; updatedAt: string; status: number }
