...
export default function Sidebar() {
  ...
  const menuClassNames = (path: string) => {
    return classNames(
      'mb-1 block cursor-default rounded-md px-4 py-2 hover:bg-sidebar-selected',
      pathname === path && 'bg-sidebar-selected',
    )
  }

  return (
    <div className="h-screen w-60 bg-sidebar p-3 relative">
