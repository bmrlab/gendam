  ...
  return (
    <div
      className={classNames(
        'text-ink flex gap-2 items-center justify-start px-6 py-2',
    ...
    >
      ...
      {explorer.isItemSelected(data) && explorerStore.isRenaming ? (
        ...
        <div className={classNames(
          'flex-1 text-xs overflow-hidden flex items-center justify-start',
...
export default function ListView({ items }: { items: ExplorerItem[] }) {
  return (
    <>
      <div className="border-app-line flex gap-2 items-center justify-start border-b px-10 py-2">
