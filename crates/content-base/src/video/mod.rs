...
mod test {
    ...
    use crate::{
        ...
        ContentBase, ContentTask, ContentTaskType, FileInfo,
    };
    use ai::{
    ...
    async fn test_video() {
        ...
        let metadata = ContentMetadata::extract(
            &file_info,
            crate::metadata::ContentType::Video,
            &content_base,
        )
        .await
        .expect("metadata extraction success");
